...
test: ## [  py] Runs the tests for the project
	...
	@test -d .venv && (. .venv/bin/activate; ENA_NR='test_ENAnummer' CLUSTER_ID='cluser-01'  GENOSCOPE_ID='EMOBON00172' OBS_ID='VB' ENVPACKAGE_ID='Wa' SAMPLE_MAT_ID='test_sm_id' pytest tests/) || :
	@test -d .venv || echo "no .venv directory found, run 'make init' to initialize the python environment"
